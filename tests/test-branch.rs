...
#[test]
fn test_br_elbr() {
    state_test!(r#"main { br 1111 { br T { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(2222)]);
    state_test!(r#"main { br 1111 { br T { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 { br T { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(2222)]);
    state_test!(r#"main { br 1111 { br T { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 { br T { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(2222)]);
    state_test!(r#"main { br 1111 { br T { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 { br F { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(4444)]);
    state_test!(r#"main { br 1111 { br F { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(4444), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 { br F { 2222 } elbr F { 4444 } } }"#, vec![]);
    state_test!(r#"main { br 1111 { br F { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 { br F { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(4444)]);
    state_test!(r#"main { br 1111 { br F { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(4444), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 { 5678 br T { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(5678), BCVal::Int(2222)]);
    state_test!(r#"main { br 1111 { 5678 br T { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(5678), BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 { 5678 br T { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(5678), BCVal::Int(2222)]);
    state_test!(r#"main { br 1111 { 5678 br T { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(5678), BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 { 5678 br T { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(5678), BCVal::Int(2222)]);
    state_test!(r#"main { br 1111 { 5678 br T { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(5678), BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 { 5678 br F { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(5678), BCVal::Int(4444)]);
    state_test!(r#"main { br 1111 { 5678 br F { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(5678), BCVal::Int(4444), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 { 5678 br F { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(5678)]);
    state_test!(r#"main { br 1111 { 5678 br F { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(5678), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 { 5678 br F { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(5678), BCVal::Int(4444)]);
    state_test!(r#"main { br 1111 { 5678 br F { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(5678), BCVal::Int(4444), BCVal::Int(8765)]);
    state_test!(r#"main { br T { br T { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(2222)]);
    state_test!(r#"main { br T { br T { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br T { br T { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(2222)]);
    state_test!(r#"main { br T { br T { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br T { br T { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(2222)]);
    state_test!(r#"main { br T { br T { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br T { br F { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(4444)]);
    state_test!(r#"main { br T { br F { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(4444), BCVal::Int(8765)]);
    state_test!(r#"main { br T { br F { 2222 } elbr F { 4444 } } }"#, vec![]);
    state_test!(r#"main { br T { br F { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(8765)]);
    state_test!(r#"main { br T { br F { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(4444)]);
    state_test!(r#"main { br T { br F { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(4444), BCVal::Int(8765)]);
    state_test!(r#"main { br T { 5678 br T { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(5678), BCVal::Int(2222)]);
    state_test!(r#"main { br T { 5678 br T { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(5678), BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br T { 5678 br T { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(5678), BCVal::Int(2222)]);
    state_test!(r#"main { br T { 5678 br T { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(5678), BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br T { 5678 br T { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(5678), BCVal::Int(2222)]);
    state_test!(r#"main { br T { 5678 br T { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(5678), BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br T { 5678 br F { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(5678), BCVal::Int(4444)]);
    state_test!(r#"main { br T { 5678 br F { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(5678), BCVal::Int(4444), BCVal::Int(8765)]);
    state_test!(r#"main { br T { 5678 br F { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(5678)]);
    state_test!(r#"main { br T { 5678 br F { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(5678), BCVal::Int(8765)]);
    state_test!(r#"main { br T { 5678 br F { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(5678), BCVal::Int(4444)]);
    state_test!(r#"main { br T { 5678 br F { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(5678), BCVal::Int(4444), BCVal::Int(8765)]);
    state_test!(r#"main { br F { br T { 2222 } elbr T { 4444 } } }"#, vec![]);
    state_test!(r#"main { br F { br T { 2222 } elbr T { 4444 } 8765 } }"#, vec![]);
    state_test!(r#"main { br F { br T { 2222 } elbr F { 4444 } } }"#, vec![]);
    state_test!(r#"main { br F { br T { 2222 } elbr F { 4444 } 8765 } }"#, vec![]);
    state_test!(r#"main { br F { br T { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![]);
    state_test!(r#"main { br F { br T { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![]);
    state_test!(r#"main { br F { br F { 2222 } elbr T { 4444 } } }"#, vec![]);
    state_test!(r#"main { br F { br F { 2222 } elbr T { 4444 } 8765 } }"#, vec![]);
    state_test!(r#"main { br F { br F { 2222 } elbr F { 4444 } } }"#, vec![]);
    state_test!(r#"main { br F { br F { 2222 } elbr F { 4444 } 8765 } }"#, vec![]);
    state_test!(r#"main { br F { br F { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![]);
    state_test!(r#"main { br F { br F { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![]);
    state_test!(r#"main { br F { 5678 br T { 2222 } elbr T { 4444 } } }"#, vec![]);
    state_test!(r#"main { br F { 5678 br T { 2222 } elbr T { 4444 } 8765 } }"#, vec![]);
    state_test!(r#"main { br F { 5678 br T { 2222 } elbr F { 4444 } } }"#, vec![]);
    state_test!(r#"main { br F { 5678 br T { 2222 } elbr F { 4444 } 8765 } }"#, vec![]);
    state_test!(r#"main { br F { 5678 br T { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![]);
    state_test!(r#"main { br F { 5678 br T { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![]);
    state_test!(r#"main { br F { 5678 br F { 2222 } elbr T { 4444 } } }"#, vec![]);
    state_test!(r#"main { br F { 5678 br F { 2222 } elbr T { 4444 } 8765 } }"#, vec![]);
    state_test!(r#"main { br F { 5678 br F { 2222 } elbr F { 4444 } } }"#, vec![]);
    state_test!(r#"main { br F { 5678 br F { 2222 } elbr F { 4444 } 8765 } }"#, vec![]);
    state_test!(r#"main { br F { 5678 br F { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![]);
    state_test!(r#"main { br F { 5678 br F { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![]);
    state_test!(r#"main { br 1111 T { br T { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Int(2222)]);
    state_test!(r#"main { br 1111 T { br T { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 T { br T { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Int(2222)]);
    state_test!(r#"main { br 1111 T { br T { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 T { br T { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Int(2222)]);
    state_test!(r#"main { br 1111 T { br T { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 T { br F { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Int(4444)]);
    state_test!(r#"main { br 1111 T { br F { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Int(4444), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 T { br F { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 T { br F { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 T { br F { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Int(4444)]);
    state_test!(r#"main { br 1111 T { br F { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Int(4444), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 T { 5678 br T { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Int(5678), BCVal::Int(2222)]);
    state_test!(r#"main { br 1111 T { 5678 br T { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Int(5678), BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 T { 5678 br T { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Int(5678), BCVal::Int(2222)]);
    state_test!(r#"main { br 1111 T { 5678 br T { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Int(5678), BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 T { 5678 br T { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Int(5678), BCVal::Int(2222)]);
    state_test!(r#"main { br 1111 T { 5678 br T { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Int(5678), BCVal::Int(2222), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 T { 5678 br F { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Int(5678), BCVal::Int(4444)]);
    state_test!(r#"main { br 1111 T { 5678 br F { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Int(5678), BCVal::Int(4444), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 T { 5678 br F { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Int(5678)]);
    state_test!(r#"main { br 1111 T { 5678 br F { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Int(5678), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 T { 5678 br F { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Int(5678), BCVal::Int(4444)]);
    state_test!(r#"main { br 1111 T { 5678 br F { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Int(5678), BCVal::Int(4444), BCVal::Int(8765)]);
    state_test!(r#"main { br 1111 F { br T { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { br T { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { br T { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { br T { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { br T { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { br T { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { br F { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { br F { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { br F { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { br F { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { br F { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { br F { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { 5678 br T { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { 5678 br T { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { 5678 br T { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { 5678 br T { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { 5678 br T { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { 5678 br T { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { 5678 br F { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { 5678 br F { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { 5678 br F { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { 5678 br F { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { 5678 br F { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br 1111 F { 5678 br F { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111)]);
    state_test!(r#"main { br T F { br T { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { br T { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { br T { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { br T { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { br T { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { br T { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { br F { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { br F { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { br F { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { br F { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { br F { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { br F { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { 5678 br T { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { 5678 br T { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { 5678 br T { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { 5678 br T { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { 5678 br T { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { 5678 br T { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { 5678 br F { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { 5678 br F { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { 5678 br F { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { 5678 br F { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { 5678 br F { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br T F { 5678 br F { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { br T { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { br T { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { br T { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { br T { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { br T { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { br T { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { br F { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { br F { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { br F { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { br F { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { br F { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { br F { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { 5678 br T { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { 5678 br T { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { 5678 br T { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { 5678 br T { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { 5678 br T { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { 5678 br T { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { 5678 br F { 2222 } elbr T { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { 5678 br F { 2222 } elbr T { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { 5678 br F { 2222 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { 5678 br F { 2222 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { 5678 br F { 2222 } elbr T { 4444 } elbr F { 4444 } } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
    state_test!(r#"main { br 1111 T F { 5678 br F { 2222 } elbr T { 4444 } elbr F { 4444 } 8765 } }"#, vec![BCVal::Int(1111), BCVal::Bool(true)]);
}
